...
instancetypes = ['setcovering', 'capacitedfacility', 'independentset', 'combinatorialauction', 'generalized_independentset', 'miplib2017_binary'
                 ]
...
def generator_switcher(dataset):
    switcher = {
        ...
        instancetypes[2] + instancesizes[0]: lambda: ecole.instance.IndependentSetGenerator(n_nodes=1000), # , affinity=80
        instancetypes[3] + instancesizes[0]: lambda: ecole.instance.CombinatorialAuctionGenerator(n_items=2000, n_bids=2000, add_item_prob=0.7), # ems=4000, n_bids=2000, add_item_prob=0.60
        ...
        instancetypes[3] + instancesizes[1]: lambda: ecole.instance.CombinatorialAuctionGenerator(n_items=8000, n_bids=4000, add_item_prob=0.60),
    }
