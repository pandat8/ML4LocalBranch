...
# lr = 0.01
# epsilon = 0.0
# instance_type = instancetypes[2]
# lbconstraint_mode = 'symmetric'
# instance_size = instancesizes[1]
# incumbent_mode = incumbent_modes[0]
#
# train_dataset = instance_type + instance_size
# directory = './result/generated_instances/' + instance_type + '/' + instance_size + '/' + lbconstraint_mode + '/' + incumbent_mode + '/'
#
# reinforce_train_directory = directory + 'rl/' + 'reinforce/train' + '/noimitation/'
# filename = f'{reinforce_train_directory}lb-rl-noregression-noimitation-reward3-train-lr{str(lr)}-epsilon{str(epsilon)}_60s_talored.pkl'  # instance 100-199
#
